...
def generate_report(transcript, call_type):
    ...
    parameters = {
        ...
        10. "Did the agent use any potentially misleading or deceptive statements?" if not then true else false.
        ...
        13. "Did the agent confirm Concession?" if yes then true else false.
        14. "Did the agent offer to read out the rates?" if yes then true else false.
        15. "Did the agent provide an estimation for low, medium, and high usage in Victoria?" if yes or customer is not from Victoria then true else false.
        16. "Did the agent answer customer questions correctly?" if yes then true else false.

        Section 4: Soft Skills
        17. "Did the agent ensure they did not interrupt the customer while they spoke?" if yes then true else false.
        18. "Did the agent display a professional manner throughout the call?" if yes then true else false.
        19. "Did the agent proactively add value throughout the call?" if yes then true else false.
        20. "Did the agent sound clear and confident throughout the call?" if yes then true else false.
        21. "Did the agent refrain from using jargon during the call?" if yes then true else false.
        22. "Did the agent sound friendly, polite, and welcoming?" if yes then true else false.
        23. "Did the agent use effective questioning skills?" if yes then true else false.
        24. "Did the agent demonstrate active listening?" if yes then true else false.
        25. "Did the agent adapt to the customer?" if yes then true else false.

        Section 5: End Call
        26. "Did the agent ask the customer, 'Do you have any other questions while I have you'?" if yes then true else false.
        27. "Did the agent close the call in an appropriate manner?" if yes then true else false.
        """,
